...
class ContractSystemTester:
    def __init__(self, base_url="https://brasil-voting.preview.emergentagent.com/api"):
...
def main():
    ...
    if tester.signature_token:
        ...
        print(f"\n🔗 Signature URL:")
        print(f"   https://brasil-voting.preview.emergentagent.com/assinar/{tester.signature_token}")
